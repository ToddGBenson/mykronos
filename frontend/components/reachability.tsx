  ...
  return (
    <div className="border border-rule bg-paper-2">
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 border-b border-rule-soft px-3 py-2">
        <span className="text-[13px] font-bold">Import reachability</span>
      ...
      {orphaned.length > 0 ? (
        <div className="px-3 py-2">
          ...
          <ul className="mt-1.5 flex flex-col gap-0.5 font-mono text-[12px] text-ink-2">
      ...
      <p className="max-w-prose border-t border-rule-soft px-3 py-2 text-[14px] leading-relaxed text-ink-3">
        {report.note}
      </p>
    </div>
  );
